...
hotkey.bind({"ctrl", "shift", "alt"}, "2", nil, move.halfWidthCenter)
...
hotkey.bind({"ctrl", "shift", "alt"}, "4", nil, move.thirdCenter)
hotkey.bind({"ctrl"}, "5", nil, move.twoThirdsLeft)
hotkey.bind({"ctrl", "shift", "alt"}, "5", nil, move.twoThirdsTopLeft)
hotkey.bind({"ctrl", "cmd", "alt"}, "5", nil, move.twoThirdsBottomLeft)
...
hotkey.bind({"ctrl", "shift", "alt"}, "/", nil, layouts.doLayoutWithExtraWideDisplay)
